		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Veiculos",
									"targetURL": "#vehicleszgpimentelvehicles-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vehicleszgpimentelvehicles-display": {
								"semanticObject": "vehicleszgpimentelvehicles",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vehicles.zgpimentelvehicles",
									"url": sap.ui.require.toUrl("vehicles/zgpimentelvehicles")
								}
							}
						}
					}
